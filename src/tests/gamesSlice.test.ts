...
describe('gamesSlice', () => {
    ...
    describe('reducers and extraReducers', () => {
        ...
        it('should handle fetchGames.fulfilled', () => {
            const mockGames: Game[] = [
                { gameId: 1, name: 'Game 1', author: 'Author 1', min: 1, max: 10, rules: { 3: 'Fizz' } },
                { gameId: 2, name: 'Game 2', author: 'Author 2', min: 1, max: 10, rules: { 5: 'Buzz' } },
            ];
    ...
    describe('async actions', () => {
        it('fetchGames should dispatch correct actions on success', async () => {
            const mockGames = { $values: [{ gameId: 1, name: 'Game 1', author: 'Author 1', min: 1, max: 10, rules: { 3: 'Fizz' } }] };
            ...
            expect(fulfilled[0].payload).toEqual(mockGames.$values);
        });
        ...
        it('addGame should dispatch correct actions on success', async () => {
          const newGame = { gameId: 3, name: 'Game 3', author: 'Author 3', min: 1, max: 100, rules: { 7: 'Bizz' } };
